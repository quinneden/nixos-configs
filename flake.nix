{
  description = "heywoodlh nix config fork";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        darwinConfig =
          machineType: myHostname: extraConf:
      ...
      #'';
      {
        ...
        packages.nixosConfigurations = {
          ...
          nixos-macserver = nixpkgs.lib.nixosSystem {
            system = "aarch64-linux";
            specialArgs = inputs;
            modules = [
              ...
              {
                networking.hostName = "nixos-macserver";
